...
const PublicSnippetViewer: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPublicSnippet = async () => {
      ...
      try {
        const response = await publicApi.get(`/public/snippets/${id}`);
        ...
        if (error.response) {
          if (error.response.status === 404) {
            errorMessage = 'Snippet not found or not public.';
          ...
          <div className="text-center py-12">
            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
              ...
              <p className="text-sm text-gray-500">
                This snippet might be private or no longer exists.
              </p>
            </div>
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            <Button
              ...
              onClick={() => {
                if (user) {
                  // If user is logged in, go back to public snippets page
                  navigate('/public-snippets');
                } else {
                  // If not logged in, go back to explore snippets page
                  navigate('/public-snippets');
                }
              }}
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Public Code Snippet</p>
            </div>
          </div>
        </div>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-gray-200">
              ...
              <div className="text-sm text-gray-500">
                <span>Shared by the community</span>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <Card className="backdrop-blur-sm bg-white/60 border-0 shadow-lg">
              <CardContent className="py-6">
                ...
                <p className="text-gray-600 mb-4">
                  Join SnipVault to create, organize, and share your code snippets with the community.
                </p>
...
export default PublicSnippetViewer; 